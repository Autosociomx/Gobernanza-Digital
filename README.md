...
- [**Diagnóstico técnico-priorizado SOATM**](./docs/marco/DIAGNOSTICO_TECNICO_PRIORIZADO_SOATM.md) — Ruta mínima de ejecución: trámite prioritario único, flujo con folio/evidencia, separación operativo vs experimental y requisitos MX.ID + inclusión lingüística.
